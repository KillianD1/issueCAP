...
Object.defineProperty(Product, 'name', { value: 'test.Products' })
Object.defineProperty(Product, 'is_singular', { value: true })
export class Products extends Array<Product> {$count?: number}
Object.defineProperty(Products, 'name', { value: 'test.Products' })
...
Object.defineProperty(ProductDescription, 'name', { value: 'test.ProductDescriptions' })
...
Object.defineProperty(ProductDescriptions, 'name', { value: 'test.ProductDescriptions' })
